...
const Chief = () => {
    const [chief, setChief] = useState({
        name: "Loading...",
        title: "Loading...",
        url: "../src/assets/fa-icons/user.svg",
        description:"Loading...",
        photo: "../src/assets/fa-icons/user.svg"
    });
    ...
    return (
        ...
        <div className= "grid grid-cols-[300px_1fr_1fr_1fr_1fr] h-100vh bg-[url('../src/assets/hero.jpg')] bg-cover bg-center text-white shadow-md mb-6">
            ...
            <div className="col-span-1 mx-auto w-3/5 py-10">
                <img src={chief.photo} alt="Chief" className="rounded-t-lg" style={{maxWidth: "102%"}} />
            ...
            <div className="col-span-2 inline-block text-lg my-10 rounded p-5 text-justify" style={{"backgroundColor": "rgba(0,0,0,0.6)"}}>{chief.description}</div>
